...
This local install is tuned for geography, human geography, GIScience, and health
geography. For spatial, map-based, environmental exposure, health geography, or
GeoAI figures, optionally consult `../shared/field-context/` before finalizing the
figure contract. Use those references to check claim framing, spatial unit and
scale assumptions, map interpretation boundaries, exposure logic, and venue fit.
Do not treat NORA as an installed or callable skill.
...
| [../shared/field-context/spatial-methods.md](../shared/field-context/spatial-methods.md) | Geography/GIScience figures need spatial-unit, scale, MAUP, autocorrelation, or map-validity checks |
| [../shared/field-context/environmental-health.md](../shared/field-context/environmental-health.md) | Health geography or environmental exposure figures need domain interpretation boundaries |
| [../shared/field-context/geoai-domain.md](../shared/field-context/geoai-domain.md) | GeoAI figures need model, benchmark, or geospatial ML framing |
