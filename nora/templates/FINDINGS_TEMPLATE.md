...
> Append only — never delete. Used by COMPACT_MODE in auto-review-loop to save context. Date-stamped entries only.

**Format**: `[YYYY-MM-DD HH:MM] [TYPE] <finding>`
...
# Geospatial Findings
## [YYYY-MM-DD] Example: MGWR performance
- MGWR AICc=1234.5 beats GWR AICc=1289.3 on CA housing dataset (Δ=−54.8)

## [YYYY-MM-DD] Example: CLAIM_REMOVED
- 20% improvement" overclaim — actual is 12% median across datasets
