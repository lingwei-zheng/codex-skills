...
Require-Text "references\question-workflow.md" 'Information Sufficiency Gate' "information sufficiency gate"
Require-Text "references\question-workflow.md" 'enhanced retrieval' "enhanced-retrieval requirement"
...
Check-LocalMarkdownReferences "references\question-workflow.md"
