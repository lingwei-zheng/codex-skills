...
**Minimal command:**
```
Research spatial inequality in urban health service access
```
...
Default output is bilingual English + Simplified Chinese unless the user requests otherwise. Academic terminology kept in English where appropriate. Socratic mode uses natural conversational style.
...
```
deep-research + geospatial data/tools   -> Evidence-based geography, GIScience, and health geography research
