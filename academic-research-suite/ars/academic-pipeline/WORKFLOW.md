...
```
I want to write a research paper on spatial inequality in urban health service access
```
...
Default output is bilingual English + Simplified Chinese unless the user requests otherwise. Academic terminology retained in English where appropriate.
...
Stage 5: academic-paper (format-convert mode)
  ...
  - Fonts: Times New Roman (English) + Source Han Serif SC VF (Chinese) + Courier New (monospace)
