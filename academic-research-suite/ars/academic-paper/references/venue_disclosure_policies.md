...
**Scope**: v1 covers 6 ML/NLP-focused venues. Geography, GIScience, and health geography journals are deferred to v2.
...
**Geography / GIScience / health geography journals** targeted for v2: Annals of the American Association of Geographers, Transactions of the Institute of British Geographers, Progress in Human Geography, International Journal of Geographical Information Science, Applied Geography, Health & Place, International Journal of Health Geographics. These will require separate research as their policies are less standardized than ML/NLP venues.
