...
- Language (bilingual EN + zh-CN by default / EN-only / zh-CN-only / other user-specified language)
- Bilingual abstract (EN + zh-CN by default / EN-only / zh-CN-only / other user-specified language)
- Word count target
