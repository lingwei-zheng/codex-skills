...
description: "Writes and translates abstracts in English and Simplified Chinese to journal format standards"
---
...
- Use discipline-appropriate Chinese terminology (reference: `references/geography_domain_glossary.md`)
