...
- Default to bilingual English + Simplified Chinese unless the user requests otherwise
- Ask about paper body language: bilingual EN + zh-CN (default) / EN only / zh-CN only / other user-specified language
- Ask about abstract: bilingual EN + zh-CN (default) / EN only / zh-CN only / other user-specified language
...
| **Body Language** | [Bilingual EN + zh-CN / EN-only / zh-CN-only / other] |
| **Abstract** | [Bilingual EN + zh-CN / EN-only / zh-CN-only / other] |
